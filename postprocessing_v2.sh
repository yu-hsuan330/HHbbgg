...
# DYto2L-2Jets_MLL-50
do 
    # python3 ./HiggsDNA/scripts/postprocessing/prepare_output_file.py --input parquet/${ver_folder}/${year}_${sample}/ --merge #--folder-structure #--output parquet/${ver_folder}/${year}_${sample}/
    # python3 ./HiggsDNA/scripts/postprocessing/prepare_output_file.py --input parquet/${ver_folder}/${year}_${sample} --root --output ""
