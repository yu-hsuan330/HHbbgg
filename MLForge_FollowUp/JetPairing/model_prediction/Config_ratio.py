...
model_param = {
    "output": "Pairing_vbf_wRatio",
    "path": "/home/cosine/HHbbgg/MLForge/results/Pairing_vbf_v3_6/DNN/DNN_modelDNN.keras",
    "scaler": "/home/cosine/HHbbgg/MLForge/results/Pairing_vbf_v3_6/DNN/DNN_scaler.pkl",
    "features": [
        "lead_ptOverM", "sublead_ptOverM", "lead_eta", "sublead_eta", 
        "lead_btagPNetB", "sublead_btagPNetB", "lead_btagPNetQvG", "sublead_btagPNetQvG",
        "n_jets","pair_ptOverM","pair_eta",
...
sample_set = "/home/cosine/HHbbgg/minitree_parquet/ver0518/mc/merged"
samples = [
    # {
    #     "name": "GluGluToHH",
    ...
    #     # "22preEE": [f"{sample_set}/22preEE_VBFToHH/NOTAG_merged.parquet"], 
    #     # "22postEE": [f"{sample_set}/22postEE_VBFToHH/NOTAG_merged.parquet"]
    #     "22preEE": [f"./22preEE_VBFHHto2B2G_CV_1_C2V_1_C3_1.root"], 
    #     "22postEE": [f"./22postEE_VBFHHto2B2G_CV_1_C2V_1_C3_1.root"]
    # },
    # {
    ...
    # },
    {
        "name": "GGJets",
        "xs": 88.75,
        "22preEE": [f"{sample_set}/22preEE_GGJets/NOTAG_merged.parquet"],
        "22postEE": [f"{sample_set}/22postEE_GGJets/NOTAG_merged.parquet"]
    },
    {
        "name": "ttHtoGG_M125",
        "xs": 0.0013,
        "22preEE": [f"{sample_set}/22preEE_ttHtoGG_M125/NOTAG_merged.parquet"],
        "22postEE": [f"{sample_set}/22postEE_ttHtoGG_M125/NOTAG_merged.parquet"] 
    },
    {
        "name": "GluGluHtoGG",
        "xs": 0.1186,
        "22preEE": [f"{sample_set}/22preEE_GluGluHtoGG_M125/NOTAG_merged.parquet"],
        "22postEE": [f"{sample_set}/22postEE_GluGluHtoGG/NOTAG_merged.parquet"] 
