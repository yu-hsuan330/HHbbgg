...
sample_set = "/home/cosine/HHbbgg/MLForge_FollowUp/samples/sample_from_Nitishi_add"
samples = [
    {
        "name": "GluGluToHH",
        "xs": 0.0311*(0.00227*0.582*2),
        "22preEE": [f"{sample_set}/22preEE_GluGlutoHHto2B2G_kl-1p00_kt-1p00_c2-0p00.root:{TreeName_mc}"], 
        "22postEE": [f"{sample_set}/22postEE_GluGlutoHHto2B2G_kl-1p00_kt-1p00_c2-0p00.root:{TreeName_mc}"]
    },
    {
        "name": "VBFToHH",
        "xs": 0.00173*(0.00227*0.582*2), 
        "22preEE": [f"{sample_set}/22preEE_VBFHHto2B2G_CV_1_C2V_1_C3_1.root:{TreeName_mc}"], 
        "22postEE": [f"{sample_set}/22postEE_VBFHHto2B2G_CV_1_C2V_1_C3_1.root:{TreeName_mc}"]
    },
    # {
    #     "name": "GJet_Pt20to40_MGG80",
    #     "xs": 242.5,
    #     "22preEE": [f"{sample_set}/22preEE_GJet_Pt20to40.root:{TreeName_mc}"],
    #     "22postEE": [f"{sample_set}/22postEE_GJet_Pt20to40.root:{TreeName_mc}"]
    # },
    # {
    #     "name": "GJet_Pt40_MGG80",
    #     "xs": 919.1,   
    #     "22preEE": [f"{sample_set}/22preEE_GJet_Pt40.root:{TreeName_mc}"],
    #     "22postEE": [f"{sample_set}/22postEE_GJet_Pt40.root:{TreeName_mc}"]
    # },
    # {
    #     "name": "GGJets",
    #     "xs": 88.75,
