...
OutputDirName = "MultiClass_DNN_VBF_1110" # All plots, models, config file will be stored here
...
Processes = [
    {
    "Class":"b-jet pair",
    "path":["../minitree/ver1108_pair/22*_VBFToHH_jet*.root"],
...
MVAs = [
    ...
    "HyperParams":{"max_depth": 2, "learning_rate": 0.01, "min_child_weight": 12.0, "min_split_loss": 0.0, "subsample": 0.7000000000000001},
    ...
    "DNNDict":{'epochs':100, 'batchsize':500,
                'model': Sequential([#Masking(mask_value=-999),
                                     Dense(64, input_dim=19, kernel_initializer='glorot_normal', activation='relu'),
