...
OutputDirName = "MultiClass_XGB_ggF_" # All plots, models, config file will be stored here
...
Classes, ClassColors = ["b-jet pair", "wrong pair"], ["#22577E", "#EF5B5B", "#F97D10"]
...
Processes = [
    {
    "Class":"b-jet pair",
    "path":["../minitree/ver0830_pair/22*_GluGluToHH*.root"],
...
MVAs = [
    ...
    "feature_bins":[
        ...
        np.linspace(0, 500, 31), np.linspace(-5, 5, 31), 15, np.linspace(0, 600, 21),
        31, 31, 31, 31,
        15, 15
    ],
    "hyperopt":True,
