...
OutputDirName = "MultiClass_XGB_test_ggF" # All plots, models, config file will be stored here
...
Classes, ClassColors = ["ggF(O)", "ggF(X)"], ["#22577E", "#EF5B5B", "#F97D10"]
...
Processes = [
    {
    "Class":"ggF(O)",
    "path":["../minitree/ver0823/22*_GluGluToHH.root"],
    ...
    "Class":"ggF(X)",
    "path":["../minitree/ver0823/22*_GluGluToHH.root"],
    "selection":"(jet1_pt > 0) & (jet2_pt > 0) & ((abs(jet1_genFlav) != 5) | (abs(jet2_genFlav) != 5))", 
    ...
    "Class":"ggF(X)",
    "path":["../minitree/ver0823/22*_GluGluToHH.root"],
    "selection":"(jet1_pt > 0) & (jet3_pt > 0) & ((abs(jet1_genFlav) != 5) | (abs(jet3_genFlav) != 5))", 
    ...
    "Class":"ggF(X)",
    "path":["../minitree/ver0823/22*_GluGluToHH.root"],
    "selection":"(jet1_pt > 0) & (jet4_pt > 0) & ((abs(jet1_genFlav) != 5) | (abs(jet4_genFlav) != 5))", 
    ...
    "Class":"ggF(X)",
    "path":["../minitree/ver0823/22*_GluGluToHH.root"],
    "selection":"(jet1_pt > 0) & (jet5_pt > 0) & ((abs(jet1_genFlav) != 5) | (abs(jet5_genFlav) != 5))", 
    "custom":[("pair1", "jet1"), ("pair2", "jet5")],
    "input_weight": 1,#("weight"), 
    },
    {
    "Class":"ggF(X)",
    "path":["../minitree/ver0823/22*_GluGluToHH.root"],
    "selection":"(jet1_pt > 0) & (jet6_pt > 0) & ((abs(jet1_genFlav) != 5) | (abs(jet6_genFlav) != 5))", 
    "custom":[("pair1", "jet1"), ("pair2", "jet6")],
    "input_weight": 1,#("weight"), 
    },
    {
    "Class":"ggF(X)",
    "path":["../minitree/ver0823/22*_GluGluToHH.root"],
    "selection":"(jet2_pt > 0) & (jet3_pt > 0) & ((abs(jet2_genFlav) != 5) | (abs(jet3_genFlav) != 5))", 
    "custom":[("pair1", "jet2"), ("pair2", "jet3")],
    "input_weight": 1,#("weight"), 
    },
    {
    "Class":"ggF(X)",
    "path":["../minitree/ver0823/22*_GluGluToHH.root"],
    "selection":"(jet2_pt > 0) & (jet4_pt > 0) & ((abs(jet2_genFlav) != 5) | (abs(jet4_genFlav) != 5))", 
    "custom":[("pair1", "jet2"), ("pair2", "jet4")],
    "input_weight": 1,#("weight"), 
    },
    {
    "Class":"ggF(X)",
    "path":["../minitree/ver0823/22*_GluGluToHH.root"],
    "selection":"(jet2_pt > 0) & (jet5_pt > 0) & ((abs(jet2_genFlav) != 5) | (abs(jet5_genFlav) != 5))", 
    "custom":[("pair1", "jet2"), ("pair2", "jet5")],
    "input_weight": 1,#("weight"), 
    },
    {
    "Class":"ggF(X)",
    "path":["../minitree/ver0823/22*_GluGluToHH.root"],
    "selection":"(jet2_pt > 0) & (jet6_pt > 0) & ((abs(jet2_genFlav) != 5) | (abs(jet6_genFlav) != 5))", 
    "custom":[("pair1", "jet2"), ("pair2", "jet6")],
    "input_weight": 1,#("weight"), 
    },
]
...
MVAs = [
    ...
    "hyperopt":True,
    "ModelParams":{"tree_method": "hist", "device": "cuda", "objective": "multi:softprob", "num_class": 2,  "eval_metric": "merror", "random_state": RandomState},
