...
def create_hyperopt_space(Algorithm):
    ...
    if Algorithm == "XGB":
        ...
        space = {
            ...
            "num_units_1": hp.choice("num_units_1", [12, 32, 64, 128, 256]),
            "num_units_2": hp.choice("num_units_2", [12, 32, 64, 128, 256]),
            "num_units_3": hp.choice("num_units_3", [12, 32, 64, 128, 256]),
