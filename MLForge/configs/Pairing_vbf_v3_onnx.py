...
OutputDirName = "results/Pairing_vbf_v3_onnx_v2" # All plots, models, config file will be stored here
...
Processes = [
    {
    "Class": "b-jet pair",
    "path": ["/home/cosine/HHbbgg/MLForge_FollowUp/JetPairing/samples/pairing_6/22*.root"],
