...
OutputDirName = "results/Pairing_vbf_test" # All plots, models, config file will be stored here
...
MVAs = [
    {
        ...
        "DNNDict":{ "ModelParams":{"epochs": 200, "batchsize": 256, "input_dim": (19,), "output_dim": len(Classes)},
