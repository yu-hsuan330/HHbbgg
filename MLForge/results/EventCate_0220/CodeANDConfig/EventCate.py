...
OutputDirName = "results/EventCate_0220" # All plots, models, config file will be stored here
...
Processes = [
    {
    "Class": "ggHH-0/1jet",
    "path": ["/home/cosine/HHbbgg/MLForge_FollowUp/samples/Pairing_vbf_0220/22*_GluGluToHH.root"],
    ...
    {
    "Class": "VBFHH-0/1jet",
    "path": ["/home/cosine/HHbbgg/MLForge_FollowUp/samples/Pairing_vbf_0220/22*_VBFToHH.root"],
    "selection": "(bjet_true_bjet_pair == 1) & (vbfjet_lead_pt < 0)",
    "input_weight": ("weight","lumi_xs"),
    },
    {
    ...
    {
    "Class": "background",
    "path": ["/home/cosine/HHbbgg/MLForge_FollowUp/samples/Pairing_vbf_0220/22*_GGJets.root", "/home/cosine/HHbbgg/MLForge_FollowUp/samples/Pairing_vbf_0220/22*_GJet*.root"],
    "selection": "event > 0",
    "input_weight": ("weight","lumi_xs"),
    },
]
...
MVAs = [
    {
        ...
        "DNNDict":{ "ModelParams":{"epochs": 200, "batchsize": 2048, "input_dim": (42,), "output_dim": len(Classes)},
